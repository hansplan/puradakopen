...
<style>
	...
	.hd_pops_footer button{margin:3px;padding:3px 10px;line-height:20px;height:inherit;font-size:12px;box-shadow:none;letter-spacing:0;border-radius:0;}
	.hd_pops_footer button strong{color:#f5f5f5;}
	.hd_pops_footer button:hover{background:black;color:white;}
