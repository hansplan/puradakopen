        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
                ...
                <div class="bo_tit">
                    ...
                    <a href="/adm/bbs/board.php?bo_table=poster&wr_id=<?php echo $list[$i]['wr_id'] ?>">
			...
			<td class="td_img">  <a href="/adm/bbs/board.php?bo_table=poster&wr_id=<?php echo $list[$i]['wr_id'] ?>"><?php echo $list[$i]['content'] ?></a></td>
