...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td>
			...
			<a href="<?php  if($row['bo_table'] !="reservation" && $row['bo_table'] !="poster"){ echo G5_BBS_URL;}else{ echo "/adm/bbs";} ?>/board.php?bo_table=<?php echo $row['bo_table'] ?>"><?php echo $row['bo_table'] ?></a>
