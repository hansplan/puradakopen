...
<?php
$sql_common = " from {$g5['board_new_table']} a, {$g5['board_table']} b, {$g5['group_table']} c where a.bo_table = b.bo_table and b.gr_id = c.gr_id and a.bo_table != 'poster'";
...
<section>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <td class=""><a href="/adm/bbs/board.php?bo_table=<?php echo $row['bo_table'] ?>&amp;wr_id=<?php echo $row2['wr_id'] ?><?php echo $comment_link ?>"><?php echo $comment ?><?php echo conv_subject($row2['wr_subject'], 100) ?></a></td>
            <td ><div><?php echo$row2['wr_1'] ?></div></td>
    ...
    <div class="btn_list03 btn_list" style="text-align:center;">
        <a href="/adm/bbs/board.php?bo_table=reservation">가맹문의게시판가기</a>
    </div>
</section>
...
if (empty($fr_date)) {
	$fr_date = date("Y-m-d", strtotime(date("Y-m-d")."-7 day"));
}
...
<div class="tbl_head01 tbl_wrap">
	...
	<div class="btn_list03 btn_list" style="text-align:center;">
        <a href="/adm/visit_date.php">접속자 더보기</a>
    </div>
</div>
