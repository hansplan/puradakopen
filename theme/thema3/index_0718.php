...
<section id="pop_pay">
	<?include_once(G5_THEME_PATH.'/sevice_pay.php');?>
</section>
     ...
     <div class="container" >
          <div class="row">
               <article class="col-md-6 col-xs-7 col-12">
					<h2 class="to-animate">푸라닭 치킨은 철저한 시장조사와 수 많은 연구를 통해 만들어낸 브랜드입니다.</h2>
					<h4 class="to-animate">치킨에서 보기 힘든 "요리와 같은 치킨"퀄리티뿐 아니라<br>전문화된 디자인으로 보는 맛을 더했습니다.</h4>
					<h4 class="to-animate">치킨,요리가되다. 푸라닭 치킨<br>푸라닭의 밝은 미래와 함께할 가맹점 사장님을 응원합니다.</h4>
...
<?php
if($_GET['mode'] == 'test'){
	include_once(G5_THEME_PATH.'/main/main_test.php');
	include_once(G5_THEME_PATH.'/main/main_design_brand_test.php');
	include_once(G5_THEME_PATH.'/main/main_banner_menu_test.php');

}else{
	include_once(G5_THEME_PATH.'/main/main.php');
	include_once(G5_THEME_PATH.'/main/main_design_brand.php');
	include_once(G5_THEME_PATH.'/main/main_banner_menu.php');
}
?>
...
.g-recaptcha{margin:20 0 10px 0px;width:100%;float:left}
