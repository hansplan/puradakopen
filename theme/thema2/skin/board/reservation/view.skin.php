...
<article id="bo_v" style="width:<?php echo "95%"; ?>; margin:auto; border:1px solid #ddd;">
    <header style='background:#f2f5f9;'>
        <h1 id="bo_v_title" style='padding-left:20px; height:40px; line-height:40px;'>
            <?php
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <div style='padding-left:20px; height:40px; line-height:40px;'>
        작성자 <strong><?php echo $view['wr_1'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong>
    ...
    <div id="bo_v_top" style='display:none;'>
        ...
        <ul class="bo_v_com" style='padding:20px;'>
    ...
    <section id="bo_v_atc" style='padding:20px;'>
		...
		<style>
			...
			.add_con dd{font-weight:bolder; margin-left:20px;text-align:center;}
				...
				.add_con span{padding:1px 10px; border-radius:10px;color:white;margin-bottom:5px;display:block;line-height:24px;}
		...
		<div class="add_con"><dt>희망지역 : </dt><dd><?print_r($view['wr_4'])?></dd></div>
		<div class="add_con"><dt>창업계기 : </dt><dd><? pathway($view['wr_5']) ?></dd></div>
